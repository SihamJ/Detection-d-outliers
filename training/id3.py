...
def id3(self):
    ...
    feature_ids = [x for x  in range(len(set.feature_names))]
...
def _id3_recv(self, x_ids, feature_ids, node):
    ...
    if (len(set(labels_in_features))) == 1:
        ...
        return node
    # if there are not more feature to compute,
    # return node with the most probable class
